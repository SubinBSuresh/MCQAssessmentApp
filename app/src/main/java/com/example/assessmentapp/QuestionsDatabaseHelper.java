...
public class QuestionsDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String TABLE_NAME = "MCQQuestions";
    private static final int DATABASE_VERSION = 1;

    //CREATE TABLE
    private static final String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME + "(assessment_name text,mcq_question_no text,mcq_question text, option1 text, option2 text, option3 text, option4 text, correct_answer text)";
    //DROP TABLE
    ...
    public ArrayList<HashMap<String, String>> getMCQData() {
        ...
        String query = "select mcq_question, option1,option2,option3,option4, correct_answer from " + TABLE_NAME;
